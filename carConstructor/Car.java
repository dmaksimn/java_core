...
public abstract class Car {
    ...
    public boolean comparePropertiesSelectCarWithCarInStorage(CarColor color, CarBody body, CarModel model, int year, CarSizeWheels sizeWheels, CarEngineVolume engineVolume) {
